...
function game_play(event)
{
  ...
  if(game_win_checker==1 && game_status ==true)
  {
    ...
    document.getElementById('game_status_html').style.color = "#163fb0";
    game_status = false;
    document.getElementById('Player_win_counter').innerHTML = p1_con+1;
    p1_con+=1;
    document.getElementById('Player_win_counter4').innerHTML = p1_con;
  }
  else if(game_win_checker==2 && game_status ==true)
  {
    ...
    document.getElementById('game_status_html').style.color = "#163fb0";
    game_status = false;
    document.getElementById('Player_win_counter3').innerHTML = p2_con+1;
    p2_con+=1;
    document.getElementById('Player_win_counter2').innerHTML = p2_con;
    turn = !turn;
  }
